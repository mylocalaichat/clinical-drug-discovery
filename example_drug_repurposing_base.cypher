// Drug Repurposing Example Graph - BASE GRAPH (without similarity edges)
// This script creates the foundational graph structure with:
// - Drugs, Diseases, Proteins, and Pathways
// - Drug-target interactions
// - Protein-disease associations
// - Pathway-disease associations
// - Known drug-disease treatments
//
// Run this FIRST, then run example_drug_repurposing_similarities.cypher
// to add the similarity edges that enable repurposing inference
